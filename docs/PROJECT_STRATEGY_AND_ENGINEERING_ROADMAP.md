...
- **P0.5 remains incomplete.** The smallest proposed next slice is a quantity/fee evidence contract, specification first and separately authorized. Establish the missing fee inputs and evidence boundary before implementation; do not infer sizing, accounting, or P1 authorization.
