...
- **P0.2B — strategy-facing indicators and feature composition: NEXT.** Establish only the additional indicator or compositional contract demonstrated necessary to specify the first hypothesis; preserve P0.2A's validation, availability, and reproducibility invariants.
