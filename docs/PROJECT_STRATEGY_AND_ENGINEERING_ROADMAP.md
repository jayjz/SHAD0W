...
- **P0.5B — explicit cost/slippage sensitivity: NEXT.** Add one narrowly specified, deterministic additional cost or slippage assumption and its sensitivity evidence to the P0.5A execution outcome boundary. Do not add portfolio evaluation, sizing, partial fills, market impact, or broker integration.
